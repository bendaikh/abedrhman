                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($comptables as $comptable)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">{{ $comptable->responsable ?? 'N/A' }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">Aucun comptable trouvé</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
