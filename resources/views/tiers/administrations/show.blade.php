...
@section('title', 'Détails de l\'administration - Abedrhman')
...
<div class="space-y-6">
    <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white">Détails de l'administration</h2>
        </div>
        <div class="flex gap-2">
            <a href="{{ route('administrations.edit', $administration->id) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors">
                Modifier
            </a>
        ...
        <div class="p-6">
            ...
            <dl class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <div>
                    ...
                    <dd class="text-base text-gray-900 dark:text-white">{{ $administration->email ?? 'N/A' }}</dd>
                </div>
                <div class="md:col-span-2">
                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Adresse</dt>
                    <dd class="text-base text-gray-900 dark:text-white">{{ $administration->adresse ?? 'N/A' }}</dd>
                </div>
            </dl>
        </div>
    </div>
