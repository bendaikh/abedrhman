...
@section('title', 'Règlements clients - Abedrhman')

@section('content')
<div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
    <div class="mb-6">
        <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-2">Règlements clients</h2>
        <p class="text-gray-600 dark:text-gray-400">Gérer les règlements des clients</p>
    </div>
