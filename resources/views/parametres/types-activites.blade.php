...
@section('title', 'Types d\'activités - Paramètres - Abedrhman')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow border border-gray-100 dark:border-gray-700 p-6">
                ...
                <form action="{{ route('parametres.types-activites.store') }}" method="POST" class="space-y-4">
                    @csrf
                    <div>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="p-4 sm:p-6 border-b border-gray-100 dark:border-gray-700 bg-violet-50 dark:bg-violet-900/20">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ $typesActivites->count() }} type(s) configuré(s)</p>
                </div>
                ...
                <div class="divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    <div class="p-4 sm:p-6 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                        <form action="{{ route('parametres.types-activites.update', $type) }}" method="POST" class="space-y-4">
                            @csrf
                            @method('PUT')
                            <div class="flex flex-col gap-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="description" rows="2"
                                        class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-colors resize-none">{{ $type->description }}</textarea>
                                </div>
                        ...
                        <form action="{{ route('parametres.types-activites.destroy', $type) }}" method="POST" class="mt-2 flex justify-end" 
