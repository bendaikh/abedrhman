...
@section('title', 'Types de charge - Paramètres - Abedrhman')
        ...
        <div class="lg:col-span-2">
            <div class="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="p-4 sm:p-6 border-b border-gray-100 dark:border-gray-700 bg-purple-50 dark:bg-purple-900/20">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ $typesCharge->count() }} type(s) de charge configuré(s)</p>
                </div>
                        ...
                        <form action="{{ route('parametres.types-charge.update', $typeCharge) }}" method="POST" class="space-y-4">
                            ...
                            <div class="flex flex-col gap-4">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        <input type="checkbox" name="is_active" id="is_active_{{ $typeCharge->id }}" {{ $typeCharge->is_active ? 'checked' : '' }}
                                            class="w-4 h-4 text-purple-600 bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 rounded focus:ring-purple-500 focus:ring-2">
                                        <label for="is_active_{{ $typeCharge->id }}" class="text-sm text-gray-700 dark:text-gray-300">Actif</label>
