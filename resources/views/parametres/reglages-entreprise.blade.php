...
@section('title', 'Réglages de l\'entreprise - Paramètres - Abedrhman')
...
<div class="space-y-6 sm:space-y-8">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow border border-gray-100 dark:border-gray-700 overflow-hidden">
            ...
            <nav class="flex -mb-px" aria-label="Tabs">
                ...
                <button type="button" onclick="switchTab('dirigeants')" id="tab-dirigeants"
                    ...
                    <div class="flex items-center justify-center gap-2">
                        ...
                        <span class="bg-teal-100 dark:bg-teal-900/50 text-teal-700 dark:text-teal-300 text-xs font-semibold px-2 py-0.5 rounded-full">{{ $settings->dirigeants->count() }}</span>
                    </div>
                </button>
                <button type="button" onclick="switchTab('associes')" id="tab-associes"
                    ...
                    <div class="flex items-center justify-center gap-2">
                        ...
                        <span>Associés</span>
                        <span class="bg-amber-100 dark:bg-amber-900/50 text-amber-700 dark:text-amber-300 text-xs font-semibold px-2 py-0.5 rounded-full">{{ $settings->associes->count() }}</span>
                    </div>
                </button>
            </nav>
        </div>
        ...
        <div id="content-general" class="tab-content">
            <form action="{{ route('parametres.reglages-entreprise.update') }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="raison_sociale" value="{{ old('raison_sociale', $settings->raison_sociale) }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="sigle" value="{{ old('sigle', $settings->sigle) }}" 
                                class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                                placeholder="Ex: SARL">
                        </div>
                        <div>
                            ...
                            <select name="forme_juridique" class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                                ...
                                <option value="SARL AU" {{ old('forme_juridique', $settings->forme_juridique) === 'SARL AU' ? 'selected' : '' }}>SARL AU</option>
                                ...
                                <option value="SCS" {{ old('forme_juridique', $settings->forme_juridique) === 'SCS' ? 'selected' : '' }}>SCS</option>
                                ...
                                <option value="Personne physique" {{ old('forme_juridique', $settings->forme_juridique) === 'Personne physique' ? 'selected' : '' }}>Personne physique</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Capital social</label>
                            <input type="text" name="capital_social" value="{{ old('capital_social', $settings->capital_social) }}" 
                                class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" name="ice" value="{{ old('ice', $settings->ice) }}" 
                                class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                                placeholder="Identifiant Commun de l'Entreprise">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Identifiant fiscal</label>
                            <input type="text" name="id_fiscale" value="{{ old('id_fiscale', $settings->id_fiscale) }}" 
                                class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                                placeholder="IF">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="rc" value="{{ old('rc', $settings->rc) }}" 
                                class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="md:col-span-2">
                            ...
                            <textarea name="siege_social" rows="3"
                                ...
                                placeholder="Adresse complète">{{ old('siege_social', $settings->siege_social) }}</textarea>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="pays" value="{{ old('pays', $settings->pays ?? 'Maroc') }}" 
                                class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                                placeholder="Pays">
                        </div>
                    </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="site_web" value="{{ old('site_web', $settings->site_web) }}" 
                                class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="secteur_activite" class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                                <option value="">Sélectionner</option>
                                <option value="COMMERCE" {{ old('secteur_activite', $settings->secteur_activite) === 'COMMERCE' ? 'selected' : '' }}>COMMERCE</option>
                                <option value="SERVICES" {{ old('secteur_activite', $settings->secteur_activite) === 'SERVICES' ? 'selected' : '' }}>SERVICES</option>
                                <option value="INDUSTRIE" {{ old('secteur_activite', $settings->secteur_activite) === 'INDUSTRIE' ? 'selected' : '' }}>INDUSTRIE</option>
                                <option value="INFORMATIQUE" {{ old('secteur_activite', $settings->secteur_activite) === 'INFORMATIQUE' ? 'selected' : '' }}>INFORMATIQUE</option>
                                <option value="CONSEIL" {{ old('secteur_activite', $settings->secteur_activite) === 'CONSEIL' ? 'selected' : '' }}>CONSEIL</option>
                                <option value="IMMOBILIER" {{ old('secteur_activite', $settings->secteur_activite) === 'IMMOBILIER' ? 'selected' : '' }}>IMMOBILIER</option>
                                <option value="TRANSPORT" {{ old('secteur_activite', $settings->secteur_activite) === 'TRANSPORT' ? 'selected' : '' }}>TRANSPORT</option>
                                <option value="AUTRE" {{ old('secteur_activite', $settings->secteur_activite) === 'AUTRE' ? 'selected' : '' }}>AUTRE</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <textarea name="activite_principale" rows="3"
                                class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors resize-none"
                                placeholder="Description de l'activité principale">{{ old('activite_principale', $settings->activite_principale) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-6">
                            ...
                            <form action="{{ route('parametres.dirigeants.store') }}" method="POST" class="space-y-4">
                                @csrf
                    ...
                    <div class="lg:col-span-2">
                        @if($settings->dirigeants->count() > 0)
                        <div class="space-y-4">
                            @foreach($settings->dirigeants as $dirigeant)
                            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 sm:p-6">
                                <form action="{{ route('parametres.dirigeants.update', $dirigeant) }}" method="POST" class="space-y-4">
                                    @csrf
                                    @method('PUT')
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Nom</label>
                                            <input type="text" name="nom" value="{{ $dirigeant->nom }}" required 
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="prenom" value="{{ $dirigeant->prenom }}" 
                                                class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Fonction</label>
                                            <input type="text" name="fonction" value="{{ $dirigeant->fonction }}" 
                                                class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">CIN</label>
                                            <input type="text" name="cin" value="{{ $dirigeant->cin }}" 
                                                class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Téléphone</label>
                                            <input type="text" name="telephone" value="{{ $dirigeant->telephone }}" 
                                                class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Email</label>
                                            <input type="email" name="email" value="{{ $dirigeant->email }}" 
                                                class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors">
                                        </div>
                                    </div>
                                    <div class="flex items-center justify-between flex-wrap gap-2">
                                        <div class="flex items-center gap-2">
                                            <input type="checkbox" name="is_representant_legal" id="is_representant_legal_{{ $dirigeant->id }}" {{ $dirigeant->is_representant_legal ? 'checked' : '' }}
                                                class="w-4 h-4 text-teal-600 bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 rounded focus:ring-teal-500 focus:ring-2">
                                            <label for="is_representant_legal_{{ $dirigeant->id }}" class="text-sm text-gray-700 dark:text-gray-300">Représentant légal</label>
                                            @if($dirigeant->is_representant_legal)
                                ...
                                <form action="{{ route('parametres.dirigeants.destroy', $dirigeant) }}" method="POST" class="mt-2 flex justify-end" 
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-6">
                            ...
                            <form action="{{ route('parametres.associes.store') }}" method="POST" class="space-y-4">
                                @csrf
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nom *</label>
                    ...
                    <!-- Associes List -->
                    <div class="lg:col-span-2">
                        @if($settings->associes->count() > 0)
                        <div class="space-y-4">
                            @foreach($settings->associes as $associe)
                            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 sm:p-6">
                                <form action="{{ route('parametres.associes.update', $associe) }}" method="POST" class="space-y-4">
                                    @csrf
                                    @method('PUT')
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Nom</label>
                                            <input type="text" name="nom" value="{{ $associe->nom }}" required 
                                        ...
                                        <div>
                                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Prénom</label>
                                            <input type="text" name="prenom" value="{{ $associe->prenom }}" 
                                                class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">CIN</label>
                                            <input type="text" name="cin" value="{{ $associe->cin }}" 
                                                class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Téléphone</label>
                                            <input type="text" name="telephone" value="{{ $associe->telephone }}" 
                                                class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Email</label>
                                            <input type="email" name="email" value="{{ $associe->email }}" 
                                                class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Parts sociales (DH)</label>
                                            <input type="number" name="parts_sociales" value="{{ $associe->parts_sociales }}" step="0.01" min="0"
                                                class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Pourcentage (%)</label>
                                            <input type="number" name="pourcentage" value="{{ $associe->pourcentage }}" step="0.01" min="0" max="100"
                                                class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors">
                                        </div>
                                    </div>
                                    <div class="flex items-center justify-between flex-wrap gap-2">
                                        <div class="flex items-center gap-2">
                                            @if($associe->pourcentage)
                                            <span class="px-2 py-0.5 text-xs font-semibold bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 rounded-full">
                                                {{ number_format($associe->pourcentage, 2) }}%
                                            </span>
                                            @endif
                                            @if($associe->parts_sociales)
                                            <span class="px-2 py-0.5 text-xs font-semibold bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-full">
                                                {{ number_format($associe->parts_sociales, 2) }} DH
                                            </span>
                                            @endif
                                        </div>
                                ...
                                <form action="{{ route('parametres.associes.destroy', $associe) }}" method="POST" class="mt-2 flex justify-end" 
