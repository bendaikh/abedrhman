...
<div class="space-y-6 sm:space-y-8">
    ...
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <!-- Offres CREA Card -->
            <a href="{{ route('parametres.offres-crea') }}" class="group bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow p-6 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-all duration-200 hover:border-amber-300 dark:hover:border-amber-600">
                <div class="flex items-center justify-between mb-4">
            ...
            <a href="{{ route('parametres.tarifications-crea') }}" class="group bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow p-6 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-all duration-200 hover:border-orange-300 dark:hover:border-orange-600">
                <div class="flex items-center justify-between mb-4">
    ...
    @if(($offresDom->count() == 0 && $offresCrea->count() == 0) || $typesTarification->count() == 0)
