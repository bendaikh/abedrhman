            ...
            <ul class="space-y-2 sm:space-y-3">
                @foreach ($unitPricing as $price)
                    <li class="flex items-start">
                        ...
                        <div>
                            <p class="text-xs sm:text-sm font-medium text-gray-800 dark:text-gray-200">{{ $price }}</p>
            ...
            <ul class="space-y-2 sm:space-y-3">
                @foreach ($packPricing as $pack)
                    <li class="flex items-start">
                        ...
                        <div>
                            <p class="text-xs sm:text-sm font-medium text-gray-800 dark:text-gray-200">{{ $pack }}</p>
