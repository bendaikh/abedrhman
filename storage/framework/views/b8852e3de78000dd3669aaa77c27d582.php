            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-100 dark:border-gray-700 p-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900 dark:text-white"><?php echo e($service->formatted_montant_total); ?></p>
                        <?php if($service->sousServices->count() > 0): ?>
                        <p class="text-xs text-indigo-600 dark:text-indigo-400">dont <?php echo e($service->sousServices->count()); ?> sous-service(s)</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
