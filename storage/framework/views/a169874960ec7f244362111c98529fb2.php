...
<?php $__env->startSection('title', 'Facture ' . $facture->numero . ' - Abedrhman'); ?>

<?php $__env->startSection('content'); ?>
<div class="space-y-6 sm:space-y-8">
    <!-- Breadcrumb -->
    <div class="flex items-center gap-2 text-sm flex-wrap">
        <a href="<?php echo e(route('factures.index')); ?>" class="text-gray-500 dark:text-gray-400 hover:text-violet-600 dark:hover:text-violet-400 transition-colors">Factures</a>
        <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
        </svg>
        <span class="text-gray-900 dark:text-white font-medium"><?php echo e($facture->numero); ?></span>
    </div>
    ...
    <div class="bg-gradient-to-r from-violet-600 to-purple-700 rounded-xl sm:rounded-2xl p-6 sm:p-8 text-white">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h2 class="text-xl sm:text-2xl font-bold mb-2">Facture <?php echo e($facture->numero); ?></h2>
                <p class="text-violet-100 text-sm sm:text-base">
                    Créée le <?php echo e($facture->created_at->format('d/m/Y à H:i')); ?>

                </p>
            </div>
            <div class="flex items-center gap-2">
                <a href="<?php echo e(route('factures.print', $facture)); ?>" target="_blank"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-100 dark:border-gray-700 p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-semibold text-gray-900 dark:text-white mt-1"><?php echo e($facture->client->dirigeants->first()->nom ?? 'N/A'); ?></p>
                    </div>
                    <?php endif; ?>
                    <div>
                        <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Adresse</p>
                        <p class="text-sm text-gray-900 dark:text-white mt-1"><?php echo e($facture->client->siege_social ?? 'N/A'); ?></p>
                    </div>
                    <div>
                        <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Ville</p>
                        <p class="text-sm text-gray-900 dark:text-white mt-1"><?php echo e($facture->client->ville ?? 'N/A'); ?></p>
                    </div>
                    <?php if($facture->client->ice): ?>
                    <div>
                        <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">ICE</p>
                        <p class="text-sm text-gray-900 dark:text-white mt-1"><?php echo e($facture->client->ice); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
                <?php else: ?>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full">
                        ...
                        <tbody>
                            <tr>
                                <td class="py-3">
                                    <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($facture->service->typeService->nom ?? 'Service'); ?></p>
                                    <?php if($facture->service->description): ?>
                                    <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($facture->service->description); ?></p>
                                    <?php endif; ?>
                                </td>
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-100 dark:border-gray-700 p-6">
                ...
                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium <?php echo e($facture->statut_color); ?>">
                    <?php echo e($facture->statut_label); ?>

                </span>
                
                <form action="<?php echo e(route('factures.update-statut', $facture)); ?>" method="POST" class="mt-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <select name="statut" onchange="this.form.submit()"
                        ...
                        <option value="brouillon" <?php echo e($facture->statut == 'brouillon' ? 'selected' : ''); ?>>Brouillon</option>
                        <option value="envoyee" <?php echo e($facture->statut == 'envoyee' ? 'selected' : ''); ?>>Envoyée</option>
                        <option value="payee" <?php echo e($facture->statut == 'payee' ? 'selected' : ''); ?>>Payée</option>
                        <option value="partielle" <?php echo e($facture->statut == 'partielle' ? 'selected' : ''); ?>>Partiellement payée</option>
                        <option value="annulee" <?php echo e($facture->statut == 'annulee' ? 'selected' : ''); ?>>Annulée</option>
                    </select>
                </form>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-100 dark:border-gray-700 p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="text-sm font-semibold text-emerald-600 dark:text-emerald-400"><?php echo e($facture->formatted_montant_paye); ?></span>
                    </div>
                    <hr class="border-gray-200 dark:border-gray-700">
                    <div class="flex justify-between">
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Reste à Payer</span>
                        <span class="text-sm font-bold <?php echo e($facture->montant_restant > 0 ? 'text-amber-600 dark:text-amber-400' : 'text-emerald-600 dark:text-emerald-400'); ?>">
                            <?php echo e($facture->formatted_montant_restant); ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-100 dark:border-gray-700 p-6">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-900 dark:text-white mt-1"><?php echo e($facture->date_facture->format('d/m/Y')); ?></p>
                    </div>
                    <?php if($facture->date_echeance): ?>
                    <div>
                        <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Date d'échéance</p>
                        <p class="text-sm font-medium text-gray-900 dark:text-white mt-1"><?php echo e($facture->date_echeance->format('d/m/Y')); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Espacegamers\Documents\abedrhman\resources\views/sections/factures-show.blade.php ENDPATH**/ ?>