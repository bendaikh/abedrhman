...
<?php $__env->startSection('title', 'Activités - Abedrhman'); ?>
...
<div class="space-y-6 sm:space-y-8">
    ...
    <div class="bg-gradient-to-r from-violet-600 to-purple-700 rounded-xl sm:rounded-2xl p-6 sm:p-8 text-white">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <a href="<?php echo e(route('activites.create')); ?>" 
    ...
    <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-6 text-center">
        ...
        <a href="<?php echo e(route('parametres.types-activites')); ?>" class="inline-flex items-center px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white font-medium rounded-lg transition-colors">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow border border-gray-100 dark:border-gray-700 overflow-hidden">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($activites->count()); ?> activité(s) enregistrée(s)</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                        <td class="px-4 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($activite->nom); ?></div>
                            <?php if($activite->description): ?>
                            <div class="text-xs text-gray-500 dark:text-gray-400 truncate max-w-xs"><?php echo e($activite->description); ?></div>
                            <?php endif; ?>
                        </td>
                        <td class="px-4 py-4 whitespace-nowrap">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-violet-100 dark:bg-violet-900/30 text-violet-800 dark:text-violet-300">
                                <?php echo e($activite->typeActivite->nom ?? 'N/A'); ?>

                            </span>
                        </td>
                        <td class="px-4 py-4 whitespace-nowrap">
                            <?php if($activite->date_debut): ?>
                            <div class="text-sm text-gray-900 dark:text-white"><?php echo e($activite->date_debut->format('d/m/Y')); ?></div>
                            <?php if($activite->date_fin): ?>
                            <div class="text-xs text-gray-500 dark:text-gray-400">→ <?php echo e($activite->date_fin->format('d/m/Y')); ?></div>
                            <?php endif; ?>
                            <?php else: ?>
                        ...
                        <td class="px-4 py-4 whitespace-nowrap">
                            <span class="text-sm text-gray-600 dark:text-gray-300"><?php echo e($activite->lieu ?? '-'); ?></span>
                        </td>
                        <td class="px-4 py-4 whitespace-nowrap">
                            <span class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($activite->formatted_prix); ?></span>
                        </td>
                        <td class="px-4 py-4 whitespace-nowrap text-center">
                            <?php if($activite->is_active): ?>
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end gap-2">
                                <a href="<?php echo e(route('activites.edit', $activite)); ?>" class="p-2 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors" title="Modifier">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    </svg>
                                </a>
                                <form action="<?php echo e(route('activites.destroy', $activite)); ?>" method="POST" class="inline" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette activité ?');">
                                    <?php echo csrf_field(); ?>
        ...
        <div class="p-8 text-center">
            ...
            <?php if($typesActivites->count() > 0): ?>
            <a href="<?php echo e(route('activites.create')); ?>" class="inline-flex items-center px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white font-medium rounded-lg transition-colors">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
                Créer une activité
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Espacegamers\Documents\abedrhman\resources\views/sections/activites.blade.php ENDPATH**/ ?>