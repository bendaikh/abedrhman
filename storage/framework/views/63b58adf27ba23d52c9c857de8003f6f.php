                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                        <td class="px-4 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($service->nom); ?></div>
                            <?php if($service->description): ?>
                            <div class="text-xs text-gray-500 dark:text-gray-400 truncate max-w-xs"><?php echo e($service->description); ?></div>
                            <?php endif; ?>
                        </td>
                        <td class="px-4 py-4 whitespace-nowrap">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap">
                            <span class="text-sm text-gray-600 dark:text-gray-300"><?php echo e($service->formatted_duree); ?></span>
                        </td>
