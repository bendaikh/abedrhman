...
<div class="space-y-6 sm:space-y-8">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow border border-gray-100 dark:border-gray-700 p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            ...
            <button 
                type="button"
                onclick="selectTypeService(<?php echo e($typeService->id); ?>, '<?php echo e($typeService->nom); ?>')"
                class="type-service-card group p-4 rounded-xl border-2 transition-all duration-200 text-left hover:shadow-lg
                    <?php echo e($loop->first ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 bg-white dark:bg-gray-800'); ?>"
                data-type-id="<?php echo e($typeService->id); ?>"
            >
                <div class="flex items-center gap-3 mb-2">
                    <div class="h-10 w-10 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center">
                        <span class="text-white font-bold text-lg"><?php echo e(strtoupper(substr($typeService->nom, 0, 1))); ?></span>
                    </div>
                    <div>
                        <h4 class="font-semibold text-gray-900 dark:text-white"><?php echo e($typeService->nom); ?></h4>
                        <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($typeService->code); ?></p>
                    </div>
                </div>
                <?php if($typeService->description): ?>
                <p class="text-xs text-gray-600 dark:text-gray-400 line-clamp-2"><?php echo e($typeService->description); ?></p>
                <?php endif; ?>
                <div class="mt-2 flex items-center gap-2">
                    <span class="px-2 py-0.5 text-xs font-medium rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300">
                        <?php echo e($typeService->offres->count()); ?> offre(s)
                    </span>
        ...
        <div class="text-center py-8">
            ...
            <a href="<?php echo e(route('parametres.types-services')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors">
    ...
    <div id="tarification-content" class="<?php echo e($typesServices->count() > 0 ? '' : 'hidden'); ?>">
        <?php if($typesServices->count() > 0): ?>
        <?php $firstTypeService = $typesServices->first(); ?>
        
        <!-- Section Header -->
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                <span id="selected-type-name"><?php echo e($firstTypeService->nom); ?></span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow border border-gray-100 dark:border-gray-700 p-6">
                    ...
                    <form action="<?php echo e(route('parametres.offres.store')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="type_service_id" id="offre_type_service_id" value="<?php echo e($firstTypeService->id); ?>">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow border border-gray-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <?php if($firstTypeService->offres->count() > 0 && $typesTarification->count() > 0): ?>
                    
                    <?php $__currentLoopData = $firstTypeService->offres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <form id="delete-offre-<?php echo e($offre->id); ?>" action="<?php echo e(route('parametres.offres.destroy', $offre)); ?>" method="POST" class="hidden">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('DELETE'); ?>
                    </form>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                    <form action="<?php echo e(route('parametres.tarifications.update', $firstTypeService)); ?>" method="POST" id="tarifications-form">
                        <?php echo csrf_field(); ?>
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap text-center">
                                            <input type="number" 
                                                ...
                                                value="<?php echo e($tarif ? $tarif->prix : ''); ?>" 
                                                min="0" 
                                                step="0.01"
                                                placeholder="—"
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap text-center">
                                            <button type="button" 
                                                onclick="if(confirm('Êtes-vous sûr de vouloir supprimer cette offre ?')) { document.getElementById('delete-offre-<?php echo e($offre->id); ?>').submit(); }"
                    ...
                    <div class="p-8 text-center">
                        ...
                        <?php if($firstTypeService->offres->count() == 0): ?>
                        ...
                        <a href="<?php echo e(route('parametres.types-tarification')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow border border-gray-100 dark:border-gray-700 p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <a href="<?php echo e(route('parametres.types-tarification')); ?>" class="group p-4 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-purple-300 dark:hover:border-purple-600 hover:shadow-md transition-all">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($typesTarification->count()); ?> types</p>
                    </div>
                </div>
            </a>
            
            <a href="<?php echo e(route('parametres.sous-services')); ?>" class="group p-4 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-indigo-300 dark:hover:border-indigo-600 hover:shadow-md transition-all">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($sousServices->count()); ?> sous-services</p>
                    </div>
                </div>
            </a>
            
            <a href="<?php echo e(route('parametres.rubriques')); ?>" class="group p-4 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-red-300 dark:hover:border-red-600 hover:shadow-md transition-all">
                <div class="flex items-center gap-3">
...
function selectTypeService(typeId, typeName) {
    ...
    window.location.href = `<?php echo e(route('parametres.index')); ?>?type_service=${typeId}`;
}
</script>
