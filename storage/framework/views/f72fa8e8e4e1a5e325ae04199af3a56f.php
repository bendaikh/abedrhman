...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="type_service_id" id="type_service_id" required
                        ...
                        <option value="<?php echo e($type->id); ?>" <?php echo e(old('type_service_id') == $type->id ? 'selected' : ''); ?>>
                            <?php echo e($type->nom); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="prix" id="prix" value="<?php echo e(old('prix', 0)); ?>" required min="0" step="0.01"
                        class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors"
                        placeholder="0.00">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <input type="number" name="duree" id="duree" value="<?php echo e(old('duree')); ?>" min="1"
                        ...
                        <select name="unite_duree" id="unite_duree"
                            ...
                            <option value="heure" <?php echo e(old('unite_duree') == 'heure' ? 'selected' : ''); ?>>Heure(s)</option>
                            <option value="jour" <?php echo e(old('unite_duree') == 'jour' ? 'selected' : ''); ?>>Jour(s)</option>
                            <option value="semaine" <?php echo e(old('unite_duree') == 'semaine' ? 'selected' : ''); ?>>Semaine(s)</option>
                            <option value="mois" <?php echo e(old('unite_duree', 'mois') == 'mois' ? 'selected' : ''); ?>>Mois</option>
                            <option value="annee" <?php echo e(old('unite_duree') == 'annee' ? 'selected' : ''); ?>>Année(s)</option>
                        </select>
                    </div>
