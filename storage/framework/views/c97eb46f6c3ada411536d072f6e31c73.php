...
<?php $__env->startSection('title', 'Base clientèle - Abedrhman'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-2 sm:gap-3 w-full lg:w-auto">
            <!-- Export Button -->
            <a href="<?php echo e(route('clients.export')); ?>" class="inline-flex items-center justify-center px-3 sm:px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors flex-1 sm:flex-initial">
            ...
            <!-- Create Button -->
            <a href="<?php echo e(route('clients.create')); ?>" class="inline-flex items-center justify-center px-3 sm:px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors w-full sm:w-auto">
                ...
                <div class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        ...
                        <div class="flex-1">
                            <div class="text-base font-medium text-gray-900 dark:text-white mb-1">
                                <?php if($client->type === 'particulier'): ?>
                                    <?php echo e(trim(($client->nom ?? '') . ' ' . ($client->prenom ?? '')) ?: 'N/A'); ?>

                                <?php else: ?>
                                    <?php echo e($client->nom_raison_sociale ?? 'N/A'); ?>

                                <?php endif; ?>
                            </div>
                            <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($client->num_client ?? 'N/A'); ?></div>
                        </div>
                    </div>
                    <div class="space-y-1 mb-3 text-sm">
                        <?php if($client->activite): ?>
                            <div class="flex items-start text-gray-600 dark:text-gray-400">
                                ...
                                <span><?php echo e($client->activite); ?></span>
                            </div>
                        <?php endif; ?>
                        <?php if($client->type === 'societe' && $client->dirigeants->count() > 0): ?>
                            <div class="flex items-start text-gray-600 dark:text-gray-400">
                                <svg class="w-4 h-4 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                </svg>
                                <div>
                                    <?php $__currentLoopData = $client->dirigeants->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dirigeant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div><?php echo e($dirigeant->nom); ?> <?php echo e($dirigeant->prenom); ?></div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($client->dirigeants->count() > 2): ?>
                                        <div class="text-xs text-gray-500">+<?php echo e($client->dirigeants->count() - 2); ?> autre(s)</div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php if($client->tel_1 ?? $client->fixe): ?>
                            <div class="flex items-center text-gray-600 dark:text-gray-400">
                                <svg class="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                </svg>
                                <?php echo e($client->tel_1 ?? ($client->fixe ?? 'N/A')); ?>
                    ...
                    <div class="space-y-2 pt-2 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center gap-2">
                            <a href="<?php echo e(route('clients.show', $client->id)); ?>" class="flex-1 inline-flex items-center justify-center px-3 py-2 text-sm bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400 hover:bg-green-100 dark:hover:bg-green-900/30 rounded-lg transition-colors" title="Voir les détails">
                            ...
                            <a href="<?php echo e(route('clients.edit', $client->id)); ?>" class="flex-1 inline-flex items-center justify-center px-3 py-2 text-sm bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/30 rounded-lg transition-colors" title="Modifier">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg>
                                Modifier
                            </a>
                            <form action="<?php echo e(route('clients.destroy', $client->id)); ?>" method="POST" class="flex-1" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce client ?');">
                                <?php echo csrf_field(); ?>
                        ...
                        <?php if($client->type === 'societe'): ?>
                            <div class="flex items-center gap-2">
                                <a href="<?php echo e(route('actionnaires.index', $client->id)); ?>" class="flex-1 inline-flex items-center justify-center px-3 py-2 text-sm bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-400 hover:bg-purple-100 dark:hover:bg-purple-900/30 rounded-lg transition-colors" title="Actionnaires">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                    </svg>
                                    Actionnaires
                                </a>
                                <a href="<?php echo e(route('dirigeants.index', $client->id)); ?>" class="flex-1 inline-flex items-center justify-center px-3 py-2 text-sm bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-900/30 rounded-lg transition-colors" title="Dirigeants">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                    Dirigeants
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="p-8 text-center">
                    <div class="text-gray-500 dark:text-gray-400">
                        ...
                        <a href="<?php echo e(route('clients.create')); ?>" class="mt-4 inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                            ...
                            <td class="px-4 lg:px-6 py-4 text-sm text-gray-500 dark:text-gray-400">
                                <?php echo e($client->activite ?? 'N/A'); ?>
                            ...
                            <td class="px-4 lg:px-6 py-4">
                                <?php if($client->type === 'societe' && $client->dirigeants->count() > 0): ?>
                                    <div class="text-sm text-gray-900 dark:text-white">
                                        <?php $__currentLoopData = $client->dirigeants->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dirigeant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="mb-1"><?php echo e($dirigeant->nom); ?> <?php echo e($dirigeant->prenom); ?></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($client->dirigeants->count() > 2): ?>
                                            <div class="text-xs text-gray-500 dark:text-gray-400">+<?php echo e($client->dirigeants->count() - 2); ?> autre(s)</div>
                                        <?php endif; ?>
                                    </div>
                                <?php else: ?>
                            ...
                            <td class="px-4 lg:px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                <?php echo e($client->ville ?? 'N/A'); ?>

                            </td>
                            <td class="px-4 lg:px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    <a href="<?php echo e(route('clients.show', $client->id)); ?>" class="text-green-600 hover:text-green-900 dark:text-green-400 dark:hover:text-green-300" title="Voir les détails">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                        </svg>
                                    </a>
                                    <a href="<?php echo e(route('clients.edit', $client->id)); ?>" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300" title="Modifier">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                        </svg>
                                    </a>
                                    <?php if($client->type === 'societe'): ?>
                                        <a href="<?php echo e(route('actionnaires.index', $client->id)); ?>" class="text-purple-600 hover:text-purple-900 dark:text-purple-400 dark:hover:text-purple-300" title="Actionnaires">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                            </svg>
                                        </a>
                                        <a href="<?php echo e(route('dirigeants.index', $client->id)); ?>" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300" title="Dirigeants">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                            </svg>
                                        </a>
                                    <?php endif; ?>
                                    <form action="<?php echo e(route('clients.destroy', $client->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce client ?');">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-xl max-w-2xl w-full p-4 sm:p-6 max-h-[90vh] overflow-y-auto">
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center justify-center">
                <a href="<?php echo e(route('clients.template')); ?>" class="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-900 dark:text-white text-sm font-medium rounded-lg transition-colors">
            ...
            <!-- Upload Form -->
            <form action="<?php echo e(route('clients.import')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                <?php echo csrf_field(); ?>
                <div>
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <p class="mt-1 text-xs sm:text-sm text-red-600 dark:text-red-400"><?php echo e($message); ?></p>
                    <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Espacegamers\Documents\abedrhman\resources\views/sections/clients.blade.php ENDPATH**/ ?>