...
<?php $__env->startSection('title', 'Tarification CREA - Paramètres - Abedrhman'); ?>
...
<div class="space-y-6 sm:space-y-8">
    ...
    <form action="<?php echo e(route('parametres.tarifications-crea.update')); ?>" method="POST">
        <?php echo csrf_field(); ?>
    ...
    <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="<?php echo e(route('parametres.offres-crea')); ?>" class="px-6 py-2.5 bg-amber-600 hover:bg-amber-700 text-white font-medium rounded-lg transition-colors flex items-center gap-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Espacegamers\Documents\abedrhman\resources\views/parametres/tarifications-crea.blade.php ENDPATH**/ ?>