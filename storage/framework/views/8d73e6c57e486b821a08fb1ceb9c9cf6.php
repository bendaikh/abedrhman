                ...
                <div class="flex-1">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="px-2 py-0.5 text-xs font-semibold rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300">
                            <?php echo e($encaisseCount); ?> paiement(s)
                        </span>
                    </div>
                    <p class="text-2xl font-bold text-emerald-600 dark:text-emerald-400 mt-1"><?php echo e(number_format($encaisseAmount, 2, ',', ' ')); ?> DH</p>
                </div>
            </div>
        </div>
                ...
                <div class="flex-1">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="px-2 py-0.5 text-xs font-semibold rounded-full bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300">
                            <?php echo e($nonEncaisseCount); ?> paiement(s)
                        </span>
                    </div>
                    <p class="text-2xl font-bold text-amber-600 dark:text-amber-400 mt-1"><?php echo e(number_format($nonEncaisseAmount, 2, ',', ' ')); ?> DH</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-100 dark:border-gray-700 p-5">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($payments->total()); ?></p>
                </div>
            </div>
        </div>
        ...
        <form method="GET" action="<?php echo e(route('payments.index')); ?>" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div>
                ...
                <select name="mode" id="mode"
                    ...
                    <option value="lcn" <?php echo e(request('mode') == 'lcn' ? 'selected' : ''); ?>>LCN (traite)</option>
                </select>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors <?php echo e(!$payment->encaisse ? 'bg-amber-50/50 dark:bg-amber-900/10' : ''); ?>">
                        ...
                        <td class="px-3 py-3 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end gap-1">
                                ...
                                <form action="<?php echo e(route('payments.toggle-encaisse', $payment)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
...
<div id="payment-modal" class="fixed inset-0 z-50 hidden">
    ...
    <div class="absolute inset-0 flex items-center justify-center p-4">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <form action="<?php echo e(route('payments.store')); ?>" method="POST" class="p-6 space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <select id="modal_client_id" onchange="updateServicesDropdown()" required
                        ...
                        <option value="<?php echo e($client->id); ?>" data-services="<?php echo e(json_encode($client->services)); ?>">
                            <?php echo e($client->type === 'morale' ? $client->nom_raison_sociale : ($client->nom . ' ' . $client->prenom)); ?>
                ...
                <div>
                    ...
                    <input type="date" name="date_paiement" id="modal_date_paiement" value="<?php echo e(date('Y-m-d')); ?>" required
                        class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors">
                </div>
